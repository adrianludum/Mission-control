...
| Race Timing | adrianludum/race-timing-app | mac-mini | ~/Projects/events/race-timing-app | — | dormant | 2026-08-12 (enrolled) | Flutter + Firebase RTDB crew race timer with OBS overlays. History is one bulk sync commit (2026-06-12). Nested path |
...
| Timer App | adrianludum/timer-app | mac-mini | ~/Projects/events/timer-app | — | dormant | 2026-08-12 (enrolled) | Single-file React + Firebase race-timer prototype; scaffold only. Keep-or-retire vs Race Timing undecided. Nested path |
