...
| Broadcast Timing App | adrianludum/timer-app | mac-mini | ~/Projects/events/timer-app | — | active | 2026-08-14 | Single-file React + Firebase timer for **live-filmed** racing: event codes, role links, OBS overlay, CSV. Renamed from "Timer App" 2026-08-14; repo/folder still `timer-app`. Adrian's active track. Not Race Timing's prototype — separate product. Nested path |
