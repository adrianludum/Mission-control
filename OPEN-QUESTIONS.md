...
- Q13: What *is* the trigger phrase, and what exactly does it write? One phrase for everything, or verbs ("log that" = decision, "park that" = question, "job for me" = blocker)?
- Q2: What counts as a "project"? Includes Claude-chat-only ideas with no repo (confirmed desired — Pace Predictor pattern). How does a chat-only project get registered and its state captured?
...
- Q6: How are projects registered — auto-scan of folders/GitHub, or curated list?
